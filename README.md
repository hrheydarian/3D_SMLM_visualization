...
Density estimation, however, is computationally challenging as one need to compute the density at each single point (or localization) to be able to assign color to each point. With the following single line of code you can visualize your SMLM data once you computed the color information:     
```matlab
